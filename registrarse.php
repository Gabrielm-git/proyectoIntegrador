...
<div class="form-group">
          <label for="inputNombre3" class="col-sm-2 control-label"style="color: white"!important;	>Nombre</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="nombre" id="inputNombre3" placeholder="nombre" required>
          </div>
        </div>
<div class="form-group">
          <label for="inputApellido3" class="col-sm-2 control-label"style="color: white"!important;	>Apellido</label>
          <div class="col-sm-10">
