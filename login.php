<?php
  ...
  $usuarios[]=$usuario;
  $usuariosFinal = json_encode($usuarios);
  file_put_contents("json/usuarios.json",$usuariosFinal);
  echo "Bienvenido, " . $usuario["nombre"] . "su usuario es " . $usuario["usuario"];
}
?>
<!DOCTYPE html>
    ...
    <div class="jumbotron jumbotron-fluid" style="background-image: url(../img/Background.jpg); margin: 0;">
      <div class="container">
    	...
    	<div class="login-html">
    		<input id="tab-1" type="radio" name="tab" class="sign-in" value="acceso.php" checked><label for="tab-1" class="tab" style="cursor: pointer";>Ingresar</label>
    		<input id="tab-2" type="radio" name="tab" class="sign-up" value="registro.php"><label for="tab-2" class="tab" style="cursor: pointer";>Registrarme</label>
            ...
            <div class="group">
              ...
              <input id="name" type="text" class="input" value="<?=$nombre?>">
    				...
    				<div class="group">
    					<label for="user" class="label">Usuario</label>
    					<input id="user" type="text" class="input" value="<?=$usuario?>">
    				</div>
    				<div class="group">
    					<label for="pass" class="label">Contraseña</label>
    				...
    				<div class="group">
    					...
    					<input id="email" type="text" class="input" value="<?=$email?>">
    				</div>
    				<div class="group">
